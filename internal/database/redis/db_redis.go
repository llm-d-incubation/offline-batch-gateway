...
// func NewBatchDBClientRedis(conf *config.BatchConfig, serviceName string) (
...
// func (c *BatchDBClientRedis) Store(ctx context.Context, job *db_api.BatchJob) (
// 	ID string, err error) {
...
// func (c *BatchDBClientRedis) Update(ctx context.Context, job *db_api.BatchJob, addJobToQueue bool) (err error) {
...
// func (c *BatchDBClientRedis) Delete(ctx context.Context, IDs []string) (
...
// func (c *BatchDBClientRedis) SendEvent(ctx context.Context, events []db_api.BatchEvent) (
...
// func dbJobFromHget(vals []interface{}, includeStatic bool) (*db_api.BatchJob, error) {
